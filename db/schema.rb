...
ActiveRecord::Schema.define(version: 20140629055323) do
  ...
  add_index "following_tags", ["tag_id"], name: "index_following_tags_on_tag_id"
  add_index "following_tags", ["user_id", "tag_id"], name: "index_following_tags_on_user_id_and_tag_id", unique: true
  add_index "following_tags", ["user_id"], name: "index_following_tags_on_user_id"
